...
.card {
  width: 100%;
  max-width: 520px; /* Puedes ajustar a 480px, 500px, etc. */
  margin: 0 auto;
  background: #fff;
  border-radius: 16px;
...
.table {
  min-width: 350px; /* Antes 500px, ahora más angosto */
  width: 100%;
...
.success-message {
  ...
  z-index: 2000;
  animation: slideIn 0.4s, fadeOut 0.4s 2.2s forwards;
}
@keyframes slideIn {
